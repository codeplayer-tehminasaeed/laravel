...
{!! Form::open(['action' => ['studentInfoController@update', $x->student_info_id], 'method' => 'POST']) !!}
      <div class="modal-body">
        <div class="form-group">
          ...
          {{Form::text('cnic',$x->std_cnic, ['class' => 'form-control', 'placeholder' => 'Enter  cnic','disabled'])}}
          </div>
          <div class="form-group">
          ...
          {{Form::text('batch_name',$x->batch_name, ['class' => 'form-control', 'placeholder' => 'Enter  Address'])}}
          </div> --}}
